    ...
    <div className="min-h-screen bg-gradient-surface">
      <div className="container mx-auto px-4 py-8 ">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base sm:text-lg text-muted-foreground l mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Card className="bg-gradient-card shadow-medium hover:shadow-large transition-all duration-300">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`p-2 rounded-lg ${
                    netAmount >= 0 ? "bg-primary/10" : "bg-warning/10"
                  }`}
                >
                  <DollarSign
                    className={`h-4 w-4 ${
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          <Link to="/expense-tracker">
            <Card className="bg-gradient-card shadow-medium hover:shadow-large transition-all duration-300 group cursor-pointer">
                    ...
                    return topCategory ? (
                      <div className="flex items-center gap-3">
                        <div
                          className="w-3 h-3 rounded-full flex-shrink-0"
                          style={{
                            backgroundColor: `hsl(var(--${topCategory.color}))`,
                          }}
                        />
        ...
        <div className="mt-8">
          <div className="text-center mb-6">
            ...
            <p className="text-muted-foreground">
              Calculator and currency converter to help with your finances
            </p>
          </div>
